...
*/
  ...
  public void draw() {
    ...
    // Add light    
    pgl.spotLight(155, 255, 255, 0, 0, 0, 0, 0, 1, (float)Math.PI/3, 1);
  ...
  public void drawCylinder() {
	pgl.pushMatrix();
	pgl.rotate((float)Math.PI/2, 0, 1, 0);
	drawCone(-5, 5, 2, 2, 20);
    pgl.popMatrix();
  }
  
  public void drawCone(float zMin, float zMax, float r1, float r2, int nbSub) {
	pgl.translate(0.0f, 0.0f, zMin);	
    my_scene.cone(nbSub, 0, 0, r1, r2, zMax-zMin);
    pgl.translate(0.0f, 0.0f, -zMin);
  }
